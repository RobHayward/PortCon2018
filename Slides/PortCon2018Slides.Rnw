...
\begin{itemize}[<+-| alert@+>]
	...
	\item The relationship between liquidity and pricing may be non-linear (it may be an inverted-U)
...
\node at (2.4, 2.3) [left] {Excess Active Return};
\end{tikzpicture}
\end{frame}
...
\begin{frame}{Economist and the one hundred dollar bill}
\begin{center}
\includegraphics[scale = 0.3]{oneHundredDollar}
\end{center}
\end{frame}
...
\includegraphics[scale = 0.1]{tyne_bridge}
\end{frame}
...
\begin{frame}{California requirement}
	\begin{block}{}
