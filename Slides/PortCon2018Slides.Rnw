...
\begin{itemize}[<+-| alert@+>]
\pause
\item Bond ETFs atttracted \$66.8bn of new business in the first 6 months of 2018 (ETFGI)
...
\begin{frame}{ESG Pressure}
	California has intrduced legislation to require funds (Calpers and Calsters) to explain how they are managing climate risk
	\pause
	\begin{block}{}
		"the effects of the changing climate, such as intense storms, rising sea levels, higher global temperatures, economic damages from carbon emissions, and other financial transition risks due to public policies to address climant change, shifting consumer attitudes, changing economics of traditional carbon-intense industries"
	\end{block}
\end{frame}
...
\begin{frame}{Turbulence: climate}
	Investors are paying increased attention to risks linked to fossile fuels
	\pause
\begin{itemize}[<+-| alert@+>]
